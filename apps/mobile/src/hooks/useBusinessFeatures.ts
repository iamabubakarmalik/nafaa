...
const TEMPLATE_FEATURES: Record<string, Partial<BusinessFeatures> & { defaultUnit?: string }> = {
  CARPET: { variants: true, variantImages: true, lengthWidthCalc: true, multiUnit: true, defaultUnit: 'sqft' },
  MOBILE: { variants: true, variantImages: true, imei: true, warranty: true, emi: true, services: true, defaultUnit: 'pcs' },
  GROCERY: { weightBased: true, expiry: true, batches: true, multiUnit: true, defaultUnit: 'kg' },
  PHARMACY: { expiry: true, batches: true, prescriptionRequired: true, multiUnit: true, defaultUnit: 'strip' },
  RESTAURANT: { variants: true, services: true, tables: true, kitchenPrinter: true, defaultUnit: 'plate' },
  SALON: { services: true, appointments: true, defaultUnit: 'service' },
  CLOTHING: { variants: true, variantImages: true, sizeMatrix: true, lengthWidthCalc: true, services: true, defaultUnit: 'pcs' },
  HARDWARE: { variants: true, lengthWidthCalc: true, weightBased: true, services: true, multiUnit: true, defaultUnit: 'pcs' },
  STATIONERY: { variants: true, multiUnit: true, defaultUnit: 'pcs' },
  COSMETICS: { variants: true, variantImages: true, expiry: true, defaultUnit: 'pcs' },
  BAKERY: { weightBased: true, expiry: true, variants: true, defaultUnit: 'pcs' },
  GENERAL: { variants: true, defaultUnit: 'pcs' },
};
