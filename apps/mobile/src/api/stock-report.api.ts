...
export const stockReportApi = {
  generate: (filters?: StockReportFilters): Promise<StockReportResponse> =>
    apiClient
      .get('/reports/stock', {
        params: {
          ...filters,
      ...
      .then((r) => unwrapOne<StockReportResponse>(r)),

  getProductDetail: (productId: string): Promise<ProductDetailResponse> =>
    apiClient
      .get(`/reports/stock/${productId}/detail`)
      .then((r) => unwrapOne<ProductDetailResponse>(r)),
};
