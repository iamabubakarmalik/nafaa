...
import PurchasesGate from '@/features/purchases/pages/PurchasesGate';
...
import PharmacyDoctorsPage from '@/features/industries/pharmacy/pages/PharmacyDoctorsPage';
...
// ─── Clinic Industry ───────────────────────────────────────────
import ClinicDashboardPage from '@/features/industries/clinic/pages/ClinicDashboardPage';
import DoctorsPage from '@/features/industries/clinic/pages/DoctorsPage';
import PatientsPage from '@/features/industries/clinic/pages/PatientsPage';
import ClinicAppointmentsPage from '@/features/industries/clinic/pages/ClinicAppointmentsPage';
import QueuePage from '@/features/industries/clinic/pages/QueuePage';
import ClinicNewAppointmentPage from '@/features/industries/clinic/pages/ClinicNewAppointmentPage';
import ClinicAppointmentDetailPage from '@/features/industries/clinic/pages/ClinicAppointmentDetailPage';
import ClinicPrescriptionsPage from '@/features/industries/clinic/pages/ClinicPrescriptionsPage';
import LabOrdersPage from '@/features/industries/clinic/pages/LabOrdersPage';
import VaccinationsPage from '@/features/industries/clinic/pages/VaccinationsPage';

// ─── Gym Industry ──────────────────────────────────────────────
import GymDashboardPage from '@/features/industries/gym/pages/GymDashboardPage';
import GymMembersPage from '@/features/industries/gym/pages/MembersPage';
import GymPlansPage from '@/features/industries/gym/pages/PlansPage';
import GymMembershipsPage from '@/features/industries/gym/pages/MembershipsPage';
import GymAttendancePage from '@/features/industries/gym/pages/AttendancePage';
import GymTrainersPage from '@/features/industries/gym/pages/TrainersPage';
import GymClassesPage from '@/features/industries/gym/pages/ClassesPage';
import GymPTSessionsPage from '@/features/industries/gym/pages/PTSessionsPage';
import EquipmentPage from '@/features/industries/gym/pages/EquipmentPage';
import MemberDetailPage from '@/features/industries/gym/pages/MemberDetailPage';

// ─── Bakery Industry ───────────────────────────────────────────
import BakeryDashboardPage from '@/features/industries/bakery/pages/BakeryDashboardPage';
import CakeCustomizerPage from '@/features/industries/bakery/pages/CakeCustomizerPage';
import CakeOrdersPage from '@/features/industries/bakery/pages/CakeOrdersPage';
import CakeOrderDetailPage from '@/features/industries/bakery/pages/CakeOrderDetailPage';
import BakeryProductsPage from '@/features/industries/bakery/pages/BakeryProductsPage';
import ProductionPage from '@/features/industries/bakery/pages/ProductionPage';
import IngredientsPage from '@/features/industries/bakery/pages/IngredientsPage';
import FreshnessPage from '@/features/industries/bakery/pages/FreshnessPage';
import BakeryBulkOrdersPage from '@/features/industries/bakery/pages/BakeryBulkOrdersPage';
import BakeryProductWizardPage from '@/features/industries/bakery/pages/BakeryProductWizardPage';
import BakeryProductDetailPage from '@/features/industries/bakery/pages/BakeryProductDetailPage';
import GymMemberWizardPage from '@/features/industries/gym/pages/GymMemberWizardPage';
import GymMemberDetailPage from '@/features/industries/gym/pages/GymMemberDetailPage';
import ClinicServiceWizardPage from '@/features/industries/clinic/pages/ClinicServiceWizardPage';
import ClinicServiceDetailPage from '@/features/industries/clinic/pages/ClinicServiceDetailPage';
...
import CarpetProductWizardPage from '@/features/industries/carpet/pages/CarpetProductWizardPage';
import CarpetProductDetailPage from '@/features/industries/carpet/pages/CarpetProductDetailPage';
import MobileProductWizardPage from '@/features/industries/mobile/pages/MobileProductWizardPage';
import MobileProductDetailPage from '@/features/industries/mobile/pages/MobileProductDetailPage';
import RetailProductWizardPage from '@/features/industries/retail/pages/RetailProductWizardPage';
import RetailProductDetailPage from '@/features/industries/retail/pages/RetailProductDetailPage';
import RestaurantMenuItemWizardPage from '@/features/industries/restaurant/pages/RestaurantMenuItemWizardPage';
import RestaurantMenuItemDetailPage from '@/features/industries/restaurant/pages/RestaurantMenuItemDetailPage';
import PharmacyMedicineWizardPage from '@/features/industries/pharmacy/pages/PharmacyMedicineWizardPage';
import PharmacyMedicineDetailPage from '@/features/industries/pharmacy/pages/PharmacyMedicineDetailPage';
import GarmentProductWizardPage from '@/features/industries/garments/pages/GarmentProductWizardPage';
import GarmentProductDetailPage from '@/features/industries/garments/pages/GarmentProductDetailPage';
import JewelryItemWizardPage from '@/features/industries/jewelry/pages/JewelryItemWizardPage';
import JewelryItemDetailPage from '@/features/industries/jewelry/pages/JewelryItemDetailPage';
import HardwareProductWizardPage from '@/features/industries/hardware/pages/HardwareProductWizardPage';
import HardwareProductDetailPage from '@/features/industries/hardware/pages/HardwareProductDetailPage';
import DairyProductWizardPage from '@/features/industries/dairy/pages/DairyProductWizardPage';
import DairyProductDetailPage from '@/features/industries/dairy/pages/DairyProductDetailPage';
import MeatProductWizardPage from '@/features/industries/meat/pages/MeatProductWizardPage';
import MeatProductDetailPage from '@/features/industries/meat/pages/MeatProductDetailPage';
import AgriProductWizardPage from '@/features/industries/agri/pages/AgriProductWizardPage';
import AgriProductDetailPage from '@/features/industries/agri/pages/AgriProductDetailPage';
import AutoPartWizardPage from '@/features/industries/autoparts/pages/AutoPartWizardPage';
import AutoPartDetailPage from '@/features/industries/autoparts/pages/AutoPartDetailPage';
import BookstoreProductWizardPage from '@/features/industries/bookstore/pages/BookstoreProductWizardPage';
import BookstoreProductDetailPage from '@/features/industries/bookstore/pages/BookstoreProductDetailPage';
import SalonServiceWizardPage from '@/features/industries/salon/pages/SalonServiceWizardPage';
import SalonServiceDetailPage from '@/features/industries/salon/pages/SalonServiceDetailPage';
import HotelRoomTypeWizardPage from '@/features/industries/hotel/pages/HotelRoomTypeWizardPage';
import HotelRoomTypeDetailPage from '@/features/industries/hotel/pages/HotelRoomTypeDetailPage';

import ServicesBizServiceWizardPage from '@/features/industries/services-biz/pages/ServicesBizServiceWizardPage';
import ServicesBizServiceDetailPage from '@/features/industries/services-biz/pages/ServicesBizServiceDetailPage';
