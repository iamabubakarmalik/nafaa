...
const RestaurantReportsV2 = lazy(() => import('@/features/industries/restaurant/pages/RestaurantReportsV2'));
const MobileReportsV2 = lazy(() => import('@/features/industries/mobile/pages/MobileReportsV2'));
const CarpetReportsV2 = lazy(() => import('@/features/industries/carpet/pages/CarpetReportsV2'));
const RetailReportsV2 = lazy(() => import('@/features/industries/retail/pages/RetailReportsV2'));
const GarmentReportsV2 = lazy(() => import('@/features/industries/garments/pages/GarmentReportsV2'));
const BakeryReportsV2 = lazy(() => import('@/features/industries/bakery/pages/BakeryReportsV2'));
const ClinicReportsV2 = lazy(() => import('@/features/industries/clinic/pages/ClinicReportsV2'));
const ServicesBizReportsV2 = lazy(() => import('@/features/industries/services-biz/pages/ServicesBizReportsV2'));
const PharmacyReportsV2 = lazy(() => import('@/features/industries/pharmacy/pages/PharmacyReportsV2'));
const JewelryReportsV2 = lazy(() => import('@/features/industries/jewelry/pages/JewelryReportsV2'));
const HardwareReportsV2 = lazy(() => import('@/features/industries/hardware/pages/HardwareReportsV2'));
const DairyReportsV2 = lazy(() => import('@/features/industries/dairy/pages/DairyReportsV2'));
const MeatReportsV2 = lazy(() => import('@/features/industries/meat/pages/MeatReportsV2'));
const AgriReportsV2 = lazy(() => import('@/features/industries/agri/pages/AgriReportsV2'));
const AutoPartsReportsV2 = lazy(() => import('@/features/industries/autoparts/pages/AutoPartsReportsV2'));
const BookstoreReportsV2 = lazy(() => import('@/features/industries/bookstore/pages/BookstoreReportsV2'));
const GymReports = lazy(() => import('@/features/industries/gym/pages/GymReportsV2'));
