...
const RestaurantPurchases = lazy(() => import('@/features/industries/restaurant/pages/RestaurantPurchasesV2'));
const MobilePurchases = lazy(() => import('@/features/industries/mobile/pages/MobilePurchasesV2'));
const CarpetPurchases = lazy(() => import('@/features/industries/carpet/pages/CarpetPurchasesV2'));
const RetailPurchases = lazy(() => import('@/features/industries/retail/pages/RetailPurchasesV2'));
