...
import { MarketplaceHomeController } from './home.controller';
...
@Module({
  ...
  controllers: [MarketplaceHomeController],
  providers: [MarketplaceHomeService, CustomerAuthGuard],
  exports: [MarketplaceHomeService],
})
