...
@ApiTags('Product Marketplace Profile')
...
export class ProductProfileController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get marketplace profile of a product' })
  ...
  @Patch()
  @ApiOperation({ summary: 'Update marketplace profile of a product' })
  updateProfile(
    @Req() req: Request,
  ...
  @Post('unpublish')
  @ApiOperation({ summary: 'Unpublish product from marketplace' })
