...
export function IntegrationFAQ({ integration, content }: { integration: Integration; content: IntegrationContent }) {
  ...
  return (
    <>
      <JsonLd id={`faq-integration-${integration.slug}`} data={schemaData} />
        ...
        <Container size="md">
          <div className="text-center mb-12">
            ...
            <h2 className={cn(
              ...
              {isUr
                ? `${integration.nameUr} کے بارے میں سوالات`
                : `Questions about ${integration.name}`}
            </h2>
          </div>
