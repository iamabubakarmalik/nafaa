...
export function FeatureFAQ({ feature, content }: { feature: Feature; content: FeatureContent }) {
  ...
  return (
    <>
      <JsonLd id={`faq-feature-${feature.slug}`} data={schemaData} />
        ...
        <Container size="md">
          <div className="text-center mb-12">
            ...
            <h2 className={cn(
              ...
              {isUr
                ? `${feature.nameUr} کے بارے میں سوالات`
                : `Questions about ${feature.nameEn}`}
            </h2>
          </div>
