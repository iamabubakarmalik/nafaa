...
export function FeatureMetrics({ content }: { content: FeatureContent }) {
    ...
    <Section variant="default" spacing="lg">
      <Container>
        ...
        >
          ...
          >
            {isUr ? 'اعداد و شمار جو کہانی کہتے ہیں' : 'Numbers that tell the story'}
          </motion.h2>
        </motion.div>
        ...
        >
          {content.keyMetrics.map((m, i) => (
            ...
            >
              <div className={cn(
                'font-display font-extrabold text-3xl lg:text-4xl text-gradient-brand',
                isUr && 'font-urdu',
              )}>
