import { Check, Sparkles, Droplet, Wind, Award, Package } from 'lucide-react';
import type { WizardStep } from '../../hooks/useCosmeticsWizard';
...
const STEPS = [
  { id: 1, label: 'Basic Info', short: 'Info', desc: 'Name, shade, price', icon: Sparkles },
  { id: 2, label: 'Skin & Ingredients', short: 'Skin', desc: 'Skin type, size', icon: Droplet },
  { id: 3, label: 'Fragrance Notes', short: 'Notes', desc: 'Family, notes', icon: Wind },
  { id: 4, label: 'Certifications & Batch', short: 'Certs', desc: 'Halal, expiry', icon: Award },
  { id: 5, label: 'Stock & Variants', short: 'Stock', desc: 'Quantity, shades', icon: Package },
] as const;

export function CosmeticsWizardStepper({ currentStep, stepValidation, onStepClick }: Props) {
  return (
