import { Check, ChefHat, Sparkles, BookOpen } from 'lucide-react';
import type { WizardStep } from '../../hooks/useRestaurantWizard';
...
const STEPS = [
  { id: 1, label: 'Menu Item', desc: 'Basic info & pricing', icon: ChefHat },
  { id: 2, label: 'Modifiers & Diet', desc: 'Spice, tags, options', icon: Sparkles },
  { id: 3, label: 'Recipe / BOM', desc: 'Ingredients (optional)', icon: BookOpen },
] as const;

export function RestaurantWizardStepper({ currentStep, stepValidation, onStepClick }: Props) {
  return (
            ...
            <div key={s.id} className="flex items-center gap-2">
              <button
                ...
                className={[
                  ...
                  isActive
                    ? 'bg-gradient-to-br from-orange-600 to-red-700 text-white shadow-md shadow-orange-500/40'
                    : isPast
