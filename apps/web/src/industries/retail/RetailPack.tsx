import { ShoppingBag, LayoutDashboard, Sparkles, Layers, AlertTriangle, Zap, Download, RefreshCw, ScanLine } from 'lucide-react';
 ...
 * Combos, multi-units, damage log, quick keys, smart reorder.
 */
export const RetailPack: IndustryPack = {
  ...
  navGroups: [
    {
      ...
      order: 20,
      items: [
        { to: '/retail-products/new', label: '+ Add Retail Product', icon: Sparkles, badge: 'FAST' },
  ...
  routes: [
    // Wizard — highest priority retail routes
