...
import type {
  CarpetWizardBasic, CarpetWizardVariant,
        ...
        {!hasVariants && (
          <div className="mt-4 rounded-xl bg-blue-50 border-2 border-blue-200 p-3 flex items-start gap-2">
            ...
            <div className="text-xs text-blue-900">
              <div className="font-extrabold mb-0.5">Single color mode</div>
              <div className="font-semibold">
                Seedha Step 3 pe stock add karo — variants create nahi honge.
              </div>
            </div>
          </div>
        )}
        ...
        <>
            ...
            <div className="flex items-center gap-2 flex-wrap justify-between">
              <div>
                ...
                <h4 className="font-extrabold text-slate-900 text-sm mt-0.5">
                  Common carpet colors — one click to add
                </h4>
              </div>
          ...
          <section className="rounded-2xl border-2 border-violet-200 bg-gradient-to-br from-violet-50 to-white p-5 space-y-3">
            <div>
              ...
              <h4 className="font-extrabold text-slate-900 text-sm mt-0.5">
                Apni marzi ka color, design code ke saath
              </h4>
            </div>
            ...
            <div className="grid sm:grid-cols-[1fr_1fr_auto_auto] gap-2 items-end">
              <Input
                ...
                placeholder="e.g. Two-Tone Beige, 17R Cream"
              />
              <Input
              ...
              <button
                ...
                className="h-11 px-5 rounded-xl bg-gradient-to-r from-violet-600 to-purple-700 hover:from-violet-700 hover:to-purple-800 text-white font-extrabold text-sm inline-flex items-center gap-1 disabled:opacity-50 shadow-md"
              >
          ...
          {/* Selected variants — each with expandable edit panel */}
          {variants.length > 0 ? (
                    ...
                    <div className="rounded-xl border-2 border-slate-200 hover:border-emerald-400 bg-white p-3 flex items-center gap-3 transition">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[10px] text-slate-500 font-bold px-1 mt-0.5 flex items-center gap-2 flex-wrap">
                          {v.designCode && (
                            <span className="font-mono">{v.designCode}</span>
                          )}
                          {v.sku && (
