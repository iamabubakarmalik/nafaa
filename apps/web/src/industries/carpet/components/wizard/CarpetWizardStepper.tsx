...
const STEPS = [
  { id: 1, label: 'Basic Info', desc: 'Product details & pricing', icon: Package },
  { id: 2, label: 'Colors / Designs', desc: 'Add variants', icon: Palette },
  { id: 3, label: 'Add Rolls', desc: 'Bulk stock entry', icon: Layers },
] as const;
            ...
            <div key={s.id} className="flex items-center gap-2">
              <button
                ...
                className={[
                  ...
                  isActive
                    ? 'bg-gradient-to-br from-emerald-600 to-emerald-700 text-white shadow-md shadow-emerald-500/40'
                    : isPast
