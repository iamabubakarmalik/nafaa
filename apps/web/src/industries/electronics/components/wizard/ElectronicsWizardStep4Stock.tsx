    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-extrabold text-blue-900">Stock Entry — 3 tareeqay</h3>
      ...
      <section className="grid sm:grid-cols-2 gap-3">
        <button type="button" onClick={() => onToggleVariants(!hasVariants)}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="font-extrabold text-slate-900 text-sm">Variants (storage/color)</div>
              <div className="text-[11px] text-slate-600 font-semibold">128/256GB, Black/White</div>
            </div>
        ...
        <button type="button" onClick={() => onToggleSerials(!hasSerials)}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="font-extrabold text-slate-900 text-sm">Serial / IMEI Tracking</div>
              <div className="text-[11px] text-slate-600 font-semibold">Phones, laptops, high-value</div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={stock.rackNumber} onChange={(e) => onUpdateStock({ rackNumber: e.target.value })}
                  ...
                  className="h-12 w-full rounded-xl border-2 border-slate-200 pl-10 pr-3 text-sm font-bold focus:outline-none focus:border-blue-500" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-2xl border-2 border-violet-300 bg-gradient-to-br from-violet-50 to-white p-5 space-y-4">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-violet-700 font-semibold">Storage / RAM / Color combos</p>
            </div>
          ...
          <div className="rounded-xl bg-white border-2 border-violet-200 p-3 space-y-2">
            ...
            {VARIANT_PRESETS.map((grp) => (
              <div key={grp.group} className="flex items-center gap-2 flex-wrap">
                <span className="text-[10px] font-extrabold uppercase text-slate-500 min-w-[55px]">{grp.group}:</span>
                {grp.items.map((it) => {
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    ...
                    <div>
                      ...
                      <input value={v.sku ?? ''} onChange={(e) => onUpdateVariant(v.tempId, { sku: e.target.value })}
                        ...
                        className="h-10 w-full rounded-lg border-2 border-slate-200 px-2 text-xs font-mono font-bold focus:outline-none focus:border-blue-500" />
                    </div>
                    <div>
      ...
      {hasSerials && (
        <section className="rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-5 space-y-4">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex-1">
              <h3 className="font-extrabold text-amber-900 text-base">Serial / IMEI Numbers</h3>
              <p className="text-xs text-amber-700 font-semibold">Har piece ki unique tracking</p>
            </div>
              ...
              {serials.map((s, i) => (
                <div key={s.tempId} className="rounded-xl border-2 border-slate-200 bg-white p-3">
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 items-end">
                    ...
                    <div>
                      <label className="block text-[9px] font-extrabold text-slate-600 uppercase mb-1">IMEI</label>
                    ...
                    <div>
                      <label className="block text-[9px] font-extrabold text-slate-600 uppercase mb-1">IMEI 2</label>
                    ...
                    <div className="flex items-end gap-1">
                      <div className="flex-1">
                        <label className="block text-[9px] font-extrabold text-slate-600 uppercase mb-1">MAC</label>
