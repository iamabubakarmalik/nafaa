import { Check, Cpu, Sparkles, Shield, Package } from 'lucide-react';
...
const STEPS = [
  { id: 1, label: 'Basic Info', shortLbl: 'Info', desc: 'Naam, brand, price', icon: Cpu },
  { id: 2, label: 'Tech Specs', shortLbl: 'Specs', desc: 'Battery, connectivity', icon: Sparkles },
  { id: 3, label: 'Warranty & Box', shortLbl: 'Warranty', desc: 'Warranty, contents', icon: Shield },
  { id: 4, label: 'Stock & Serials', shortLbl: 'Stock', desc: 'IMEI, variants', icon: Package },
] as const;
