        ...
        {s.bargainEnabled && (
          <div className="mt-4 pt-4 border-t-2 border-purple-200">
            ...
            <p className="text-xs text-purple-700 mt-1 font-medium">
              Original price ka minimum {s.bargainMinPercent ?? 80}% neechay offer manzoor nahi honge
            </p>
          </div>
        )}
      </FeatureCard>
...
function FeatureCard({ icon: Icon, gradient, title, description, checked, onChange, children }: any) {
  return (
