...
const AppliancesReceiptPage = lazy(() => import('@industries/appliances/pages/AppliancesReceiptPage'));
...
export default function ReceiptGate() {
  ...
  if (industry?.id === 'appliances') return <Suspense fallback={<Loader />}><AppliancesReceiptPage /></Suspense>;
