import type { CarpetReturnOptions } from '@industries/carpet/components/CarpetReturnOptionsDialog';
import { parseCarpetNoteClient } from '@industries/carpet/components/CarpetReturnOptionsDialog';
