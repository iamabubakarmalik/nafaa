import { Check, Gem, Sparkles, Award } from 'lucide-react';
import type { WizardStep } from '../../hooks/useJewelryWizard';
...
const STEPS = [
  { id: 1, label: 'Item Identity', desc: 'Metal, purity, weight', icon: Gem },
  { id: 2, label: 'Charges & Stones', desc: 'Making, gemstones, hallmark', icon: Sparkles },
  { id: 3, label: 'Certify & Tags', desc: 'Certificate, collections', icon: Award },
] as const;

export function JewelryWizardStepper({ currentStep, stepValidation, onStepClick }: Props) {
  return (
            ...
            <div key={s.id} className="flex items-center gap-2">
              <button
                ...
                className={[
                  ...
                  isActive
                    ? 'bg-gradient-to-br from-amber-600 to-yellow-700 text-white shadow-md shadow-amber-500/40'
                    : isPast
