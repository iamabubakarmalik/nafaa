import { Check, Shirt, Palette, Package } from 'lucide-react';
import type { WizardStep } from '../../hooks/useGarmentWizard';
...
const STEPS = [
  { id: 1, label: 'Product Info', desc: 'Design & fabric', icon: Shirt },
  { id: 2, label: 'Variants', desc: 'Size × Color matrix', icon: Palette },
  { id: 3, label: 'Stock & Settings', desc: 'Inventory + services', icon: Package },
] as const;

export function GarmentWizardStepper({ currentStep, stepValidation, onStepClick }: Props) {
  return (
            ...
            <div key={s.id} className="flex items-center gap-2">
              <button
                ...
                className={[
                  ...
                  isActive
                    ? 'bg-gradient-to-br from-pink-600 to-fuchsia-700 text-white shadow-md shadow-pink-500/40'
                    : isPast
