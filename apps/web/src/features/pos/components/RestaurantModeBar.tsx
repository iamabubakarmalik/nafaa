...
import { tablesApi, type TableStatus } from '@/features/industries/restaurant/api/tables.api';
import type { OrderMode } from '@/features/industries/restaurant/api/orders.api';
