...
export default function ProductFormPage() {
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      ...
      // Set data immediately to avoid refetch flicker
      queryClient.setQueryData(['product', saved.id], saved);
      // Invalidate lists but don't await — let them refetch in background
      queryClient.invalidateQueries({ queryKey: ['products'] });
      ...
      // Auto-navigate to edit mode (WITH replace so back button doesn't return to "new")
      if (!isEdit) {
